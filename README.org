...
[[./docs/sprint0/imgs/layout.png]]

+ SpaceFood is your answer to "What do we have to eat tonight, honey ?". Say
  goodbye to *hangry* and say hello to the *future*.
+ Notable features include :
  + Database storage of your favorite dishes
  + Generated grocery list
  + Generated dish list
  + Flagging healthy and unhelathy dishes
  + Calories Counter

** Maintainers
+ @philippeVoNam (Author)
